...
try
{
	...
	ResultSet rs=st.executeQuery("select * from add_student inner join insert_result where add_student.rollNo=insert_result.rollNo and add_student.rollNo='"+rollNo+"'");
	if(rs.next()){
%>
